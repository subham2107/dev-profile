        ...
        <div>
            ...
            <div className="devGithubInfo">
                ...
                <div>
                    ...
                    <a href = {`https://github.com/${this.state.id}`} target="_blank"><img className="companyIcon" src={'/images/iconfinder_github_317712.png'} alt="icon" /></a>
                    {this.state.hackerrank_id?<a href = {`https://www.hackerrank.com/${this.state.hackerrank_id}`} target="_blank"><img className="companyIcon" src={'/images/iconfinder_160_Hackerrank_logo_logos_4373234.png'} alt="icon"/></a>:null}
                    {this.state.codechef_id?<a href = {`https://www.codechef.com/users/${this.state.codechef_id}`} target="_blank"><img className="companyIcon" src={'/images/codechef-1324440139527402917_32.png'} alt="icon"/></a>:null}
                    {this.state.linkedin_id?<a href = {`https://www.linkedin.com/in/${this.state.linkedin_id}`} target="_blank"><img className="companyIcon" src={'/images/iconfinder_2018_social_media_popular_app_logo_linkedin_3225190.png'} alt="icon"/></a>:null}
                    {this.state.medium_id?<a href = {`https://medium.com/@${this.state.medium_id}`} target="_blank"><img className="companyIcon" src={'/images/iconfinder_Circled_Medium_svg5_5279113.png'} alt="icon"/></a>:null}
